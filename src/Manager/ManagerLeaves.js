...
const ManagerLeaves = () => {
  ...
  return (
    <div className="ManagerLeaves" style={{ marginTop: "80px" }}>
      <button
        className="ManagerLeavesNavigator-btn"
        onClick={() => navigator("/addmanagerleaves")}
      >
        Apply Manager Leaves{" "}
        <IoArrowRedoCircleOutline size={30} className="svg" />
      </button>
      <Container>
        <Row>
            ...
            return (
              <Col sm={12} md={9} lg={3}>
                <Card className="ManagerLeaves-card">
                  ...
                  {/* <Card.Footer> */}
                  <button
                    className="ManagerLeavesdetails-btn"
                    onClick={() => {
      ...
      <Modal show={showSelected} onHide={() => setshowSelected(false)}>
        ...
        <Modal.Footer>
          <Button variant="primary" onClick={() => setshowSelected(false)}>
            OK
          </Button>
        </Modal.Footer>
      </Modal>
